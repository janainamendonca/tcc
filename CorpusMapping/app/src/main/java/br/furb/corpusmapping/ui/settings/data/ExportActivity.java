...
import br.furb.corpusmapping.util.preferences.GeneralPrefs;
...
public class ExportActivity extends BaseActivity {
   ...
   /* @Override
    ...
    public static enum Destination {
        File {
            @Override
            public boolean startExportProcess(FragmentActivity activity, GeneralPrefs generalPrefs) {
        ...
        public abstract boolean startExportProcess(FragmentActivity activity, GeneralPrefs generalPrefs);
    }
}
